...
public class GlobalExceptionsHandler {
    ...
    public ResponseEntity<ApiError> handleDomainValidationExceptions(RuntimeException ex, HttpServletRequest req) {
        log.error("Invalid order at {}: {}", req.getRequestURI(), ex.getMessage(), ex);
        String msg = "Invalid order data. Verify order details.";
